...
if ($wm == 1) {
    ...
    $q = "SELECT * FROM `stock` INNER JOIN `product` ON `stock`.`product_id` = `product`.`id`  WHERE `product`.`gender_gender_id` = '1' AND `category_cat_id` = '1' ORDER BY `stock`.`stock_id` ASC ";
...
?>
        ...
        <div id="menShirtArea" class="col-12 product-section-heading bg-black d-flex text-light position-sticky top-0">
            Men shirts
        </div>
    ...
    $q3 = "SELECT * FROM `stock` INNER JOIN `product` ON `stock`.`product_id` = `product`.`id`  WHERE `product`.`gender_gender_id` = '1' AND `category_cat_id` = '2' ORDER BY `stock`.`stock_id` ASC ";
    ...
    ?>
        ...
        <div id="menPantArea" class="col-12 product-section-heading bg-black d-flex text-light position-sticky top-0">
            Men Pants
        </div>
